...
public class scott_lab13Test 
{
	...
	public void getTotalCount() {
		assertEquals(1000.0, lab.getTotalCount(), 0.0001);
	}
	
	@Test
	public void getOddCount() {
		assertEquals(507.0, lab.getOddCount(), 0.0001);
	}
	
	@Test
	public void getEvenCount() {
		assertEquals(493.0, lab.getEvenCount(), 0.0001);
	}
	
	@Test
	public void getDistinctGreaterThanFiveCount() {
		assertEquals(94.0, lab.getDistinctGreaterThanFiveCount(), 0.0001);
	}
